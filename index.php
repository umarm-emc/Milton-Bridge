...
<head>
  ...
  <link rel="stylesheet" href="templates/<?php echo $this->template; ?>/css/animations.css">
  <link rel="stylesheet" href="templates/<?php echo $this->template; ?>/css/animations-ie-fix.css">
</head>
...
<div id="innerwrap">
      ...
      <div id="bannerwrap" class="clearfix">
        <div class="internal-container">
          ...
          <div id="bannercontrols">
            <jdoc:include type="modules" name="bannercontrols" style="xhtml" />
          </div>
      </div>
    </div>
    <?php endif; ?>
    ...
    <?php include_once $template_path .'/tpls/abovewrap.php'; ?>

    <?php include_once $template_path .'/tpls/mainwrap.php'; ?>

    <?php include_once $template_path .'/tpls/grid2wrap.php'; ?>

    <?php include_once $template_path .'/tpls/belowwrap.php'; ?>
...
<script src="https://use.typekit.net/hoj5mhf.js"></script>
...
<script src="templates/<?php echo $this->template; ?>/js/css3-animate-it.js"></script>
</body>
</html>
